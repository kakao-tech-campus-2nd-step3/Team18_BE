...
public class ResumeService {
  ...
  private ResumeResponse mapResumeToResumeResponse(Resume resume){
    return new ResumeResponse(resume.getResumeId(),resume.getApplicantName(), resume.getAddress(), resume.getPhoneNumber(),resume.getCareer(),resume.getKorean(),resume.getSelfIntroduction());
  }
